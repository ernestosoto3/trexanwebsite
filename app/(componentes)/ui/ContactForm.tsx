...
export default function ContactForm({ industry = "Gobierno" }: ContactFormProps) {
  const title = "Asegure la trazabilidad de sus activos ahora";

  const subtitle = useMemo(() => {
    const safeIndustry = (industry || "Gobierno").trim();
  ...
  const handleReset = () => {
    setFormData({
      ...
      phone: "",
      company: "",
      industry: (industry || "Gobierno").toLowerCase(),
      volume: "",
      contactPreference: "email", // ✅ reset back to Email
      message: "",
      privacy: false,
    });
  };
          ...
          >
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2.5 border border-zinc-300 bg-white focus:border-emerald-600 focus:ring-1 focus:ring-emerald-600 outline-none"
              >
                {/* ✅ No placeholder needed since Email is preselected */}
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-zinc-600">
                Acepto recibir comunicaciones de Recibásicos. Estamos comprometidos
                con tu privacidad. Usaremos la información proporcionada para
                contactarte sobre nuestros servicios. Puedes darte de baja en
                cualquier momento.{" "}
                <span className="text-zinc-400">(opcional)</span>
              </p>
            </div>
