...
export default function GobiernoPage() {
  return (
    <main className="min-h-dvh bg-white">
      ...
      <IntroText>
        Proveemos a las instituciones públicas un modelo de baja de activos electrónicos basado en la transparencia
        ...
        rendición de cuentas impecable.
      </IntroText>
